...
class EnhancedFrameworkRunner:
    ...
    def _demo_preprocessing(self) -> Dict:
        ...
        processed_mri = (mri_data - mri_data.mean()) / (mri_data.std() + 1e-8)
    ...
    def run_training(self, data_path: Optional[str] = None) -> Dict:
    ...
    def run_validation(self, model_path: Optional[str] = None, test_data_path: Optional[str] = None) -> Dict:
    ...
    def run_full_pipeline(self, data_dir: Optional[str] = None) -> Dict:
...
Examples:
    ...
    parser.add_argument(
        '--mode',
        choices=['demo', 'train', 'validate', 'full'],
        default='demo',
    ...
    parser.add_argument(
        '--data_dir',
        type=str,
        help='Root directory containing training and test data'
    )
    ...
    parser.add_argument(
        '--mlflow',
        action='store_true',
        help='Enable MLflow tracking if mlflow is installed'
    )
