...
class MedicalSegmentationMetrics:
    ...
    def __init__(self, num_classes: int = 4, class_names: list[str] | None = None):
        """
    ...
    def dice_coefficient(
        self, pred: np.ndarray, target: np.ndarray, class_idx: int | None = None
    ) -> float | np.ndarray:
        """
    ...
    def jaccard_index(self, pred: np.ndarray, target: np.ndarray, class_idx: int | None = None) -> float | np.ndarray:
        """
    ...
    def specificity(self, pred: np.ndarray, target: np.ndarray, class_idx: int | None = None) -> float | np.ndarray:
        """
    ...
    def hausdorff_distance(
        self, pred: np.ndarray, target: np.ndarray, class_idx: int | None = None, percentile: int = 95
    ) -> float | np.ndarray:
        """
