...
def create_ablation_visualizations(results):
    ...
    bars1 = axes[0, 0].bar(range(len(df)), df['Dice Score'], color=colors)
    ...
    bars2 = axes[0, 1].bar(x_pos, values, color=colors_mod)
    ...
    bars3 = axes[1, 0].bar(strategies, strategy_scores, color=colors_fusion)
    ...
    bars4 = axes[1, 1].bar(comp_names, comp_values, color=colors_comp)
