...
This script scans directories like brats_enhanced_results/, evaluation_results/, sota_validation_results/
and consolidates per-case and aggregate metrics into CSV and LaTeX tables suitable for Q2投稿。
"""
...
def _extract_brats_summary(report: Dict[str, Any]) -> Dict[str, float]:
    ...
    for key in ['detailed_wt_tc_et', 'detailed_results', 'batch_statistics']:
        if key in report and isinstance(report[key], dict):
            ...
            for m in [
                'WT_Dice_mean','TC_Dice_mean','ET_Dice_mean',
                'WT_Hausdorff95_mean','TC_Hausdorff95_mean','ET_Hausdorff95_mean'
            ]:
