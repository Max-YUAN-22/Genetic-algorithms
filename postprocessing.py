...
def postprocess_segmentation(pred: np.ndarray, config: PostprocessConfig | None = None) -> np.ndarray:
    """
...
def postprocess_wt_tc_et(pred: np.ndarray, config: PostprocessConfig | None = None) -> np.ndarray:
    """
